    ...
    steps: [
      {
        ...
        enter: function () {
          P.renderCard('<b>错误！</b>交集不是把两个集合的元素<b>拼在一起</b>——<br>交集中的每一个元素，都必须<b>同时属于</b>两个集合。', 'warm', 'headShake');
        },
      },
      {
      ...
      },
      {
        ...
        enter: function () {
          P.renderCard('<b>正确。</b>无论先看 $A$ 还是先看 $B$，找的都是同一批公共元素——交集运算满足<b>交换律</b>。', null, 'tada');
        },
      },
      {
