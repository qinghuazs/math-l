...
(function (CW) {
  ...
  var scene = {
    ...
    steps: [
      {
        narration: '把古今方法放在一起对照：《九章算术》的算筹方阵对应今天的系数排列，"遍乘"对应方程两边同乘，"直除"对应两式相减消元。而欧洲要到 17、18 世纪才由莱布尼茨等人系统研究线性方程组——中国的方程术领先了大约一千五百年！',
        enter: function () {
          S.actor('s4-title', 0, 7.0, '古今对照：领先约 1500 年', { color: RED, size: 22, bold: true });
          P.renderTable({
            head: ['《九章算术》（汉代）', '现代方法'],
            rows: [
              ['算筹方阵（列为方程）', '方程组 / 增广矩阵'],
      ...
      {
        narration: '更重要的是方法背后的思想：不管是二元、三元，还是将来大学里的 n 元方程组，核心永远是**消元**——把未知数一个一个减少，化繁为简、化未知为已知。这个思想两千年前的中国古人就掌握了，今天仍是线性代数的基石。',
        enter: function () {
