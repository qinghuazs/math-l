...
(function (CW) {
  ...
  var scene = {
    ...
    steps: [
      {
        // 步骤1：从二元到三元，问题情境
        narration: '同学们，我们已经学会了解二元一次方程组——含有两个未知数。那么，如果一个问题中出现了<b>三个未知数</b>，我们该怎么办呢？先来看一个例子：某次数学竞赛中，甲、乙、丙三人的得分满足：甲乙丙之和为 6 分，甲与丙之差加上乙得 2 分，甲加乙减丙等于 0 分。设甲得 $x$ 分、乙得 $y$ 分、丙得 $z$ 分，就得到了一个含三个未知数的方程组！',
        enter: function (anim) {
          // 背景卡
